...
$port = 2302
$flags = "-client -nosound -connect=localhost -password=1969 -hugePages -filePatching -setThreadCharacteristics -exThreads=7 -malloc=system -limitFPS=75"
...
$arma3serverProcessName = "arma3server_x64"
